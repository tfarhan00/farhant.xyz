...
<svelte:head>
	...
	<meta
		name="description"
		content="Tengku Farhan is an eclectic web developer with an interest in React, NextJS, and TailwindCSS."
	/>
	<meta
		name="keywords"
...
<div id="root-contain" class="w-full bg-neutral-800 text-white antialiased overflow-hidden">
	<Header />
	<slot />
</div>
